...
public class GalleryAdapter2 extends RecyclerView.Adapter<GalleryAdapter2.GalleryViewHolder> {
    ...
    public GalleryAdapter2(Activity activity, ArrayList<String> myDataset) {
        mDataset = myDataset;
    ...
    public GalleryViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        CardView cardView = (CardView) LayoutInflater.from(parent.getContext()).inflate(R.layout.item_gallery2, parent, false);
